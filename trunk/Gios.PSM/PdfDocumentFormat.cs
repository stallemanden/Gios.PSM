...
namespace Gios.PDF.SplitMerge
{
	...
	/// </summary>
    internal class PdfDocumentFormat
	{
		...
		/// </summary>
		internal static PdfDocumentFormat A4
		{
			get
			{
		...
		/// </summary>
		internal static PdfDocumentFormat A4_Horizontal
		{
			get
			{
		...
		/// </summary>
		internal static PdfDocumentFormat Letter_8_5x11
		{
			get
			{
		...
		/// </summary>
		internal static PdfDocumentFormat Letter_8_5x11_Horizontal
		{
			get
			{
		...
		/// <returns></returns>
		internal static PdfDocumentFormat InInches(double Width,double Height)
		{
		...
		/// <param name="Height"></param>
		/// <returns></returns>
		internal static PdfDocumentFormat InCentimeters(double Width,double Height)
		{
			if (Width<=0) throw new Exception("Width must be grater than zero.");
			if (Height<=0) throw new Exception("Height must be grater than zero.");
